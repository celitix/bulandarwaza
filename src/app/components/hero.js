...
export default function HeroSection() {
  const heading = "Buland Darwaza".split("");
    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-[#daa520] text-5xl md:text-[90px] lg:text-[140px] font-semibold tracking-wider flex justify-center"
        >
